...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // --- VALIDASI CSRF TOKEN (WAJIB) ---
    if (!isset($_POST['csrf_token']) || !validateCSRFToken($_POST['csrf_token'])) {
        echo "<script>alert('Sesi tidak valid (CSRF Token Mismatch)!'); window.location='doctors';</script>";
        exit;
    }
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="../img/<?php echo $d['foto']; ?>" style="width:50px; height:50px; object-fit:cover; border-radius:50%;"></td>
                        ...
                        <td>
                            ...
                            <a href="?delete=<?php echo $d['kd_dokter']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus?')"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <!-- INPUT CSRF TOKEN (WAJIB ADA DI SETIAP FORM) -->
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <!-- Hidden fields untuk data yang jarang diisi -->
