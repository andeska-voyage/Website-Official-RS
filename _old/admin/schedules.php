...
// Ambil list dokter & poliklinik untuk dropdown
 $db->query("SELECT kd_dokter, nm_dokter FROM dokter ORDER BY nm_dokter");
 $dokters = $db->resultSet();
 $db->query("SELECT * FROM poliklinik");
 $polis = $db->resultSet();

// Query Jadwal (TANPA ALIAS)
...
<div class="card">
    <div class="card-header">Manajemen Jadwal Praktek</div>
    <div class="card-body">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?delete=1&kd=<?php echo $s['kd_dokter']; ?>&hari=<?php echo $s['hari_kerja']; ?>&mulai=<?php echo $s['jam_mulai']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus?')">
