...
if(isset($_GET['delete'])){ $db->query("DELETE FROM services WHERE id=:id"); $db->bind(':id', $_GET['delete']); $db->execute(); header('Location: services'); }
 ...
 $icon_list = ['fas fa-hospital'=>'Hospital','fas fa-house-medical'=>'Home Visit', 'fas fa-user-md'=>'Dokter', 'fas fa-procedures'=>'Rawat Inap', 'fas fa-ambulance'=>'IGD', 'fas fa-flask'=>'Lab', 'fas fa-heartbeat'=>'Jantung', 'fas fa-baby'=>'Bayi', 'fas fa-syringe'=>'Imunisasi', 'fas fa-stethoscope'=>'Pemeriksaan', 'fas fa-pills'=>'Farmasi'];
