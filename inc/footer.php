                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-primary btn-sm-square rounded-circle me-2" href=""><i class="fab fa-facebook-f text-white"></i></a>
                                <a class="btn btn-primary btn-sm-square rounded-circle me-2" href=""><i class="fab fa-instagram text-white"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <a href="team" class="text-body mb-3"><i class="fas fa-angle-right me-2 text-primary"></i> Tim Kami</a>
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <div class="d-flex mb-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Jl. Terandam No.5, Padang Tim.</small>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">+62 823 9185 6461</small>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Back to Top (Pastikan ini ada, jika sudah ada tidak perlu duplikat) -->
        <a href="#" class="btn btn-primary border-3 border-primary rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a>
